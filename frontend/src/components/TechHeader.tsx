          ...
          <div className="flex items-center justify-between h-16">
            ...
            >
              <div className="relative">
                <img src="/logo.jpg" alt="SportMaps Logo" className="w-10 h-10 object-contain rounded-xl bg-white p-0.5 shadow-glow-primary group-hover:shadow-glow-accent transition-all duration-300 group-hover:scale-110" />
              </div>
              <div>
