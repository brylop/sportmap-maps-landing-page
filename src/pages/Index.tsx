...
import { School, Store, Pill, Heart, Search, Calendar, Shield, Box, Truck, Bot, Repeat, UserCheck, Video, Lock, Handshake, GraduationCap, Megaphone, Package, Sparkles, RotateCcw, Activity } from "lucide-react";
  ...
  return (
    <div className="flex min-h-screen bg-sport-background">
      ...
      <main className="flex-1 lg:ml-72 p-4 sm:p-6 md:p-8 transition-all duration-300">
        ...
        {/* Ecosistema Section */}
        <section id="ecosistema" className="bg-sport-card rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 mb-6 sm:mb-8 shadow-elegant">
        ...
        {/* Escuelas Section */}
        <section id="escuelas" className="bg-sport-card rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 mb-6 sm:mb-8 shadow-elegant">
        ...
        {/* Tienda Section */}
        <section id="tienda" className="bg-sport-card rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 mb-6 sm:mb-8 shadow-elegant">
        ...
        {/* Nutrición Section */}
        <section id="nutricion" className="bg-sport-card rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 mb-6 sm:mb-8 shadow-elegant">
        ...
        {/* Bienestar Section */}
        <section id="bienestar" className="bg-sport-card rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 mb-6 sm:mb-8 shadow-elegant">
        ...
        {/* Únete Section */}
        <section id="unete" className="bg-sport-card rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 mb-6 sm:mb-8 shadow-elegant">
        ...
        {/* Acerca Section */}
        <section id="acerca" className="bg-sport-card rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 mb-6 sm:mb-8 shadow-elegant">
